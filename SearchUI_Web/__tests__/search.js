...
var searchbox = document.getElementsByClassName('searchMe')
var timer = 0;
var arr = [];
var responseArr = [];
var volume;
...
async function search() {
    ...
    let query = searchbox[0].value + "~" + volume;
    console.log(query);
...
async function start() {
    ...
    var chars = ['[', ']', '\\', '"'];
    replaceAll(chars,arr);
}

//Filtering and removing extra characters
export function replaceAll(chars,arr) {
